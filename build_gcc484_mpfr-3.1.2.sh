...
PKG_NAME="mpfr"
DOWNLOAD_URL="http://ftp.jaist.ac.jp/pub/GNU/mpfr/mpfr-3.1.2.tar.gz"
SRC_FILE="mpfr-3.1.2.tar.gz"
SRC_FILE_MD5="181aa7bb0e452c409f2788a4a7f38476"
SRC_DIR_NAME="mpfr-3.1.2"
...
# make
./configure --prefix=$Work_Root/srcs/gcc-inst-4.8.4/ --with-gmp=$Work_Root/srcs/gcc-inst-4.8.4/
make -j 4
