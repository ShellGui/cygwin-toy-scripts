...
SRC_FILE="shadowsocks-libev-2.5.6.tar.gz"
SRC_FILE_MD5="8dbde3cc317d437d56a4d807b8eabf02"
SRC_DIR_NAME="shadowsocks-libev-2.5.6"
...
if check_builded; then
	cp -vr $Work_Root/srcs/${PKG_NAME}_build/${SRC_DIR_NAME}/src/*.exe $Work_Root/dist/shadowsocks-libev
fi
