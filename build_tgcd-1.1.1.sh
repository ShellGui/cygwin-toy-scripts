...
PKG_NAME="tgcd"
DOWNLOAD_URL="http://download2.nust.na/pub4/sourceforge/t/tg/tgcd/tgcd/1.1.1/tgcd-1.1.1.tar.gz"
SRC_FILE="tgcd-1.1.1.tar.gz"
SRC_FILE_MD5="763118039a73c801a236b49e6199e1a2"
SRC_DIR_NAME="tgcd-1.1.1"
DIST_FILES='tgcd,cygwin1.dll'
...
LIBS="-ldl " LDFLAGS="-Wl,-static -static -static-libgcc " ./configure # --host=i686-pc-cygwin
make
...
if check_builded; then
	cp -vr $Work_Root/srcs/${PKG_NAME}_build/${SRC_DIR_NAME}/*.exe $Work_Root/dist/tgcd
fi
